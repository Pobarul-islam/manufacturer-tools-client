    ...
    return (
        <div className='container mx-auto mt-10 card shadow-xl'>
           ...
           <p>
            ...
            <p>Mission</p>
            <p>To develop a community of passionate motorcycle users with a view to</p>
            <ol className='my-4'>
                <li className='my-2'>- integrate and unite them based on their mutual needs and interests</li>
                <li className='my-2'>- enlighten them to reach the global standard of scopes of motorcycling</li>
                <li className='my-2'>- empower them with upgrades and tailored solutions to realize their desire</li>
                <li className='my-2'>- professionalize their hobbies for a sustainable balance of work and pleasure</li>
                <li className='my-2'>- liberate them for exploring the beautiful creation of Allah Subhanahu wa Ta’ala on their favorite ride.</li>
            </ol>
        </div>
    )
}
